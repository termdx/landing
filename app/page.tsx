	...
	return (
		<main className="relative min-h-screen max-w-3xl mx-auto px-6 py-20 md:py-32">
			...
			<header className="flex items-center justify-between mb-24">
				<div className="text-sm tracking-widest uppercase crt-glow">termdx</div>
			...
			<Reveal>
				<section className="mb-28">
					...
					<p className="text-lg md:text-xl text-crt-green/80 max-w-lg leading-relaxed">
						Terminal Developer Experience. <br className="hidden md:block" />
			...
			<Reveal>
				<section className="mb-28">
					<div className="flex items-baseline gap-3 mb-8">
						<h2 className="text-xl font-bold crt-glow">mission</h2>
					</div>
			...
			<Reveal>
				<section className="mb-28">
					<div className="flex items-baseline gap-3 mb-8">
						<h2 className="text-xl font-bold crt-glow">products</h2>
					</div>

					<div className="crt-border p-6 md:p-8 mb-8">
			...
			<Reveal>
				<section className="mb-28">
					<div className="flex items-baseline gap-3 mb-8">
						<h2 className="text-xl font-bold crt-glow">install</h2>
					</div>
			...
			<Reveal>
				<section className="mb-28">
					<div className="flex items-baseline gap-3 mb-8">
						<h2 className="text-xl font-bold crt-glow">roadmap</h2>
					</div>
			...
			<Reveal>
				...
				<div className="mt-8 text-[10px] text-crt-gray/50 leading-relaxed">
					...
					<Prompt>
						<Comment>{"// "}No tracking. No cookies. Just code.</Comment>
					</Prompt>
				</div>
			</footer>
			</Reveal>
